    ...
    return (
        <section>
            <div className="account">
                <p className="account-header">Мой аккаунт</p>
                <div className="account-wtd">
                    <button className="account-wtd-item" onClick={() => { setInfo(false); navigate("/account") }}>
                        ...
                        <span className={`account-menu favorites ${!infoPage && "underline"}`} />
                    </button>
                    <button className="account-wtd-item" onClick={() => { setInfo(true); navigate("/account/settings") }}>
                        ...
                        <span className={`account-menu settings ${infoPage && "underline"}`} />
                    </button>
                </div>
